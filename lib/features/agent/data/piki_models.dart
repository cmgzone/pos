...
class PikiStep {
  ...
  static IconData _decodeIcon(int codePoint) {
    ...
    if (codePoint == Icons.search_rounded.codePoint) return Icons.search_rounded;
    if (codePoint == Icons.bar_chart_rounded.codePoint) return Icons.bar_chart_rounded;
    if (codePoint == Icons.inventory_2_rounded.codePoint) return Icons.inventory_2_rounded;
    ...
    if (codePoint == Icons.trending_up_rounded.codePoint) return Icons.trending_up_rounded;
    if (codePoint == Icons.timer_rounded.codePoint) return Icons.timer_rounded;
    if (codePoint == Icons.event_busy_rounded.codePoint) return Icons.event_busy_rounded;
    if (codePoint == Icons.people_alt_rounded.codePoint) return Icons.people_alt_rounded;
    if (codePoint == Icons.leaderboard_rounded.codePoint) return Icons.leaderboard_rounded;
    if (codePoint == Icons.money_off_rounded.codePoint) return Icons.money_off_rounded;
    if (codePoint == Icons.local_shipping_rounded.codePoint) return Icons.local_shipping_rounded;
    if (codePoint == Icons.auto_awesome.codePoint) return Icons.auto_awesome;
    if (codePoint == Icons.note_alt_rounded.codePoint) return Icons.note_alt_rounded;
