...
const _retailModuleStyles = <int, _RetailModuleStyle>{
  0: _RetailModuleStyle(
    ...
    colors: _RetailModuleColors(
      ...
      iconBackground: Color(0xFFFFE6CD),
      iconColor: Color(0xFFD96A16),
      border: Color(0xFFF3DDCA),
    ),
    emphasized: true,
  ),
  ...
  20: _RetailModuleStyle(
    ...
    colors: _RetailModuleColors(
      ...
      iconColor: Color(0xFFBD5E14),
      border: Color(0xFFF0DDC9),
    ),
  ),
  ...
  25: _RetailModuleStyle(
    ...
    colors: _RetailModuleColors(
      ...
      iconBackground: Color(0xFFFFE6D0),
      iconColor: Color(0xFFC9661B),
      border: Color(0xFFF1DFCD),
    ),
  ),
  ...
  28: _RetailModuleStyle(
    ...
    colors: _RetailModuleColors(
      ...
      iconBackground: Color(0xFFFFE6D2),
      iconColor: Color(0xFFC66A1B),
      border: Color(0xFFF1DFCD),
    ),
  ),
